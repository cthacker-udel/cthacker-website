...
export const AboutMe = (): JSX.Element => (
    <>
        <Head>
            ...
            />
            <meta
                content="About me info of full-stack developer Cameron Thacker"
                name="description"
            />
        ...
        <BasicLayout>
            <div
                className={`d-flex flex-column justify-content-center align-items-center w-100 ${aboutMeStyles.about_me_page}`}
            >
                <div
